...
// function calculateCartPrice(val1,val2, ...num2){ //(val1=200,val2=400) it will only print 500 the value of 200,400 contains.
//     return num2
// }
// console.log(calculateCartPrice(200,400,500))//here we give many variables.but we require only 1 variables.
...
function returnSecondvalue(getArray){
    //here (retrun type me) mynewArray nahi lenge kyuki vo ek generic name he. 
    //hamare paas argument aara he hume uski 2 value print karni he.
    return getArray[1]
}
console.log(returnSecondvalue(myNewArray));// vaariable me array paas karo ya array ka name paas karo.
